...
{
    public partial class FrmTransferDataExport : Form
    {
        public FrmTransferDataExport()
        {
            InitializeComponent();
        }
        ...
        private void btnnext_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                FrmTransferDesData frmTransfer = new FrmTransferDesData();
                Hide();
                frmTransfer.Show();
            }
        }
        ...
        private void FrmTransferDataExport_Load(object sender, EventArgs e)
        {
        ...
        private void FrmTransferDataExport_FormClosing(object sender, FormClosingEventArgs e)
        {
            DialogResult tl;
