...
{
    public partial class FrmTransferDesData : Form
    {
        public FrmTransferDesData()
        {
            InitializeComponent();
        }
        ...
        private void btnnext_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    FrmListTableSource frmListTable = new FrmListTableSource();
                    this.Hide();
                    frmListTable.Show();
                }
            }
        ...
        {
            FrmTransferDataExport frmTransfer = new FrmTransferDataExport();
            Hide();
            frmTransfer.Show();
        }
        ...
        private void FrmTransferDesData_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void FrmTransferDesData_FormClosing(object sender, FormClosingEventArgs e)
        {
            DialogResult tl;
